          ...
          <div class="col-md-6">
              ...
              @csrf
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $setting->config_key }}"class="form-control" name="config_key" placeholder="Nhập config key">
                    @error('config_key')
                ...
                @if($setting->type === 'Text')
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $setting->config_value }}"class="form-control" name="config_value" placeholder="Nhập config value">
                        @error('config_value')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                @elseif($setting->type === 'Textarea')
                    <div class="form-group">
                        <label>Config value</label>
                        <textarea class="form-control" name="config_value" placeholder="Nhập config value">{{ $setting->config_value }}</textarea>
                        @error('config_value')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
